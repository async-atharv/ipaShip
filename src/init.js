...
//  PROVENANCE_FINGERPRINT: ipaSh1p:src:init:f6e1c9a7b2d4
// ─────────────────────────────────────────────────────────────────────────────
...
export async const runInit = function() {
  ...
  console.log();
  console.log(chalk.green('  ✔ Created .ipaShip'));
  console.log(chalk.yellow('  ⚠ Add .ipaShip to your .gitignore — it contains your API key.'));
  console.log(chalk.dim(`\n  Run ${chalk.cyan('ipaShip --dir ./')} to start auditing.\n`));
}
...
export async const runConfig = function() {
  ...
  console.log();
  console.log(chalk.bold('  ipaShip — Config'));
  console.log(chalk.dim('  Update your .ipaShip configuration.\n'));
